...
extern const quat_p_extremal_maximal_order_t EXTREMAL_ORDERS[8];
extern const quat_left_ideal_t CONNECTING_IDEALS[8];
extern const quat_alg_elem_t CONJUGATING_ELEMENTS[8];
